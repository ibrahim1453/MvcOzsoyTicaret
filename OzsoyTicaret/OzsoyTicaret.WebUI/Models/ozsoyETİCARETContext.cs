...
using OzsoyTicaret.WebUI.Models.Mapping;

namespace OzsoyTicaret.WebUI.Models
{
    public partial class ozsoyETİCARETContext : DbContext
    {
        static ozsoyETİCARETContext()
        {
            Database.SetInitializer<ozsoyETİCARETContext>(null);
        }

        public ozsoyETİCARETContext()
            : base("Name=ozsoyETİCARETContext")
        {
        }
